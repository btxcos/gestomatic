...
public final class CLReferencias 
{
	...
	public static ArrayList<ActivoTabla> buscarActivoAsociadoConProvisiones(String sNURCAT)
	{
		return QMListaReferencias.getActivoConProvisiones(ConnectionManager.getDBConnection(),sNURCAT);
	}
	...
	public static ArrayList<ActivoTabla> buscarActivoAsociadoConComunidad(String sNURCAT)
	{
		return QMListaReferencias.getActivoConComunidadAsociada(ConnectionManager.getDBConnection(),sNURCAT);
	}
	
	public static ArrayList<ActivoTabla> buscarActivoAsociadoConCuotas(String sNURCAT)
	{
		return QMListaReferencias.getActivoConCuotasAsociadas(ConnectionManager.getDBConnection(),sNURCAT);
	}
	
	public static ArrayList<ActivoTabla> buscarActivoAsociadoConRecursos(String sNURCAT)
	{
		return QMListaReferencias.getActivoConRecursosAsociados(ConnectionManager.getDBConnection(),sNURCAT);
	}
	...
	public static ArrayList<ReferenciaTabla> buscarReferenciasActivoConFiltro(ReferenciaTabla filtro, String sComparadorSuelo, String sComparadorCatastral, int iCodCOACES)
	{
