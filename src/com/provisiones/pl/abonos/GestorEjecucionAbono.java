			...
			try
			{
				...
				else
				{
					...
					case 0: //Sin errores
						...
						sMsg = "La ejecución del Abono se ha registrado correctamente.";
						msg = Utils.pfmsgInfo(sMsg);
						logger.info(sMsg);
						break;
					...
					case -902: //Error 902 - error y rollback - error al resolver la relación del Gasto
						sMsg = "[FATAL] ERROR:902 - Se ha producido un error al resolver la relación del Gasto. Por favor, revise los datos y avise a soporte.";
						msg = Utils.pfmsgFatal(sMsg);
						logger.error(sMsg);
						break;
						
					case -903: //Error 903 - error y rollback - error al resolver la relación Gasto-Provisión
						sMsg = "[FATAL] ERROR:903 - Se ha producido un error al resolver la relación Gasto-Provisión. Por favor, revise los datos y avise a soporte.";
						msg = Utils.pfmsgFatal(sMsg);
						logger.error(sMsg);
						break;

					case -904: //Error 904 - error y rollback - error al actualizar la Provisión
						sMsg = "[FATAL] ERROR:904 - Se ha producido un error al actualizar la Provisión. Por favor, revise los datos y avise a soporte.";
						msg = Utils.pfmsgFatal(sMsg);
						logger.error(sMsg);
						break;
						
					case -905: //Error 905 - error y rollback - error al establecer la provisión como pagada
						sMsg = "[FATAL] ERROR:905 - Se ha producido un error al establecer la provisión como pagada. Por favor, revise los datos y avise a soporte.";
						msg = Utils.pfmsgFatal(sMsg);
						logger.error(sMsg);
						break;
