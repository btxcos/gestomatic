...
public final class Utils 
{
	...
	public static String compruebaISO20022(String sCampo)
	{
		...
		sCampoFormateado = sCampo.replaceAll("[Ñ]", "N");
		sCampoFormateado = sCampoFormateado.replaceAll("[ñ]", "n");
		sCampoFormateado = sCampoFormateado.replaceAll("[Ç]", "C");
		sCampoFormateado = sCampoFormateado.replaceAll("[ç]", "c");
		sCampoFormateado = sCampoFormateado.replaceAll("[ÀÁÂÃÄÅ]", "A");
		sCampoFormateado = sCampoFormateado.replaceAll("[àáâãäå]", "a");
		sCampoFormateado = sCampoFormateado.replaceAll("[Æ]", "A");
		sCampoFormateado = sCampoFormateado.replaceAll("[æ]", "a");
		sCampoFormateado = sCampoFormateado.replaceAll("[ÈÉÊË]", "E");
		sCampoFormateado = sCampoFormateado.replaceAll("[èéêë]", "e");
		sCampoFormateado = sCampoFormateado.replaceAll("[ÌÍÎÏ]", "I");
		sCampoFormateado = sCampoFormateado.replaceAll("[ìíîï]", "i");
		sCampoFormateado = sCampoFormateado.replaceAll("[ÒÓÔÖ]", "O");
		sCampoFormateado = sCampoFormateado.replaceAll("[òóôö]", "o");
		sCampoFormateado = sCampoFormateado.replaceAll("[ÙÚÛÜ]", "U");
		sCampoFormateado = sCampoFormateado.replaceAll("[ùúûü]", "u");
