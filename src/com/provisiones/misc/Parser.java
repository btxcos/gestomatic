...
public final class Parser {
	...
	public static MovimientoGasto leerGasto (String linea)
	{
		...
		String sFEDEVE = limpiaCampoNumerico(linea.substring(Posiciones.GA_FEDEVE_P, Posiciones.GA_FEDEVE_P+Longitudes.FEDEVE_L));
		String sFFGTVP = limpiaCampoNumerico(linea.substring(Posiciones.GA_FFGTVP_P, Posiciones.GA_FFGTVP_P+Longitudes.FFGTVP_L));
		String sFEPAGA = limpiaCampoNumerico(linea.substring(Posiciones.GA_FEPAGA_P, Posiciones.GA_FEPAGA_P+Longitudes.FEPAGA_L));
		String sFELIPG = limpiaCampoNumerico(linea.substring(Posiciones.GA_FELIPG_P, Posiciones.GA_FELIPG_P+Longitudes.FELIPG_L));
		String sCOSIGA = limpiaCampoNumerico(linea.substring(Posiciones.GA_COSIGA_P, Posiciones.GA_COSIGA_P+Longitudes.COSIGA_L));
		String sFEEESI = limpiaCampoNumerico(linea.substring(Posiciones.GA_FEEESI_P, Posiciones.GA_FEEESI_P+Longitudes.FEEESI_L));
		String sFEECOI = limpiaCampoNumerico(linea.substring(Posiciones.GA_FEECOI_P, Posiciones.GA_FEECOI_P+Longitudes.FEECOI_L));
		String sFEEAUI = limpiaCampoNumerico(linea.substring(Posiciones.GA_FEEAUI_P, Posiciones.GA_FEEAUI_P+Longitudes.FEEAUI_L));
		String sFEEPAI = limpiaCampoNumerico(linea.substring(Posiciones.GA_FEEPAI_P, Posiciones.GA_FEEPAI_P+Longitudes.FEEPAI_L));
		...
		String sFEPGPR = limpiaCampoNumerico(linea.substring(Posiciones.GA_FEPGPR_P, Posiciones.GA_FEPGPR_P+Longitudes.FEPGPR_L));
		String sFEAPLI = limpiaCampoNumerico(linea.substring(Posiciones.GA_FEAPLI_P, Posiciones.GA_FEAPLI_P+Longitudes.FEAPLI_L));
	...
	public static String escribirOrdenanteN3414 (OrdenanteN3414 ordenante)
	{
		String sResultado = ordenante.getsCodRegistro()
				...
				+ formateaCampoAlfanumerico(ordenante.getsCuentaOrdenante(),Longitudes.N3414_CUENTA_ORDENANTE_L)
				+ ordenante.getsDetallesCargos()
				+ formateaCampoAlfanumerico(ordenante.getsNombreOrdenante(),Longitudes.N3414_NOMBRE_ORDENANTE_L)
				+ formateaCampoAlfanumerico(ordenante.getsDireccionOrdenante1(),Longitudes.N3414_DIRECCION_ORDENANTE1_L)
				+ formateaCampoAlfanumerico(ordenante.getsDireccionOrdenante2(),Longitudes.N3414_DIRECCION_ORDENANTE2_L)
				+ formateaCampoAlfanumerico(ordenante.getsDireccionOrdenante3(),Longitudes.N3414_DIRECCION_ORDENANTE3_L)
	...
	public static String escribirBeneficiarioTransferenciaN3414 (TransferenciaN3414 transferencia)
	{
		...
		String sResultado = ValoresDefecto.DEF_CODIGO_REGISTRO_BENEFICIARIO_N3414
				...
				+ formateaCampoAlfanumerico(transferencia.getsCuentaBeneficiario(),Longitudes.N3414_CUENTA_BENEFICIARIO_L)
				...
				+ ValoresDefecto.DEF_PROPOSITO_TRANSFERENCIA_N3414
	...
	public static String escribirResumenN3414 (ResumenN3414 resumen)
	{
		...
		String sResultado = resumen.getsCodRegistro()
				...
				+ formateaCampoNumerico(resumen.getsTotalImportes(),Longitudes.N3414_TOTAL_IMPORTES_L)
				+ formateaCampoNumerico(resumen.getsNumeroRegistros(),Longitudes.N3414_NUM_REGISTROS_L)
				+ formateaCampoNumerico(resumen.getsTotalRegistros(),Longitudes.N3414_TOTAL_REGISTROS_L)
	...
	public static String escribirTotalesN3414 (TotalesN3414 totales)
	{
		...
		String sResultado = totales.getsCodRegistro()
				...
				+ formateaCampoNumerico(totales.getsTotalImportesGeneral(),Longitudes.N3414_TOTAL_IMPORTES_L)
				+ formateaCampoNumerico(totales.getsNumeroRegistros(),Longitudes.N3414_NUM_REGISTROS_L)
				+ formateaCampoNumerico(totales.getsTotalRegistros(),Longitudes.N3414_TOTAL_REGISTROS_L)
				+ ValoresDefecto.LIBRE560;
